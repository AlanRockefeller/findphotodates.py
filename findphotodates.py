...
# Media extensions (photos + videos) — used by --only-media
MEDIA_EXTENSIONS = PHOTO_EXTENSIONS | VIDEO_EXTENSIONS
# Backward-compatible alias used by saved scan configs
DEFAULT_EXTENSIONS = MEDIA_EXTENSIONS
...
def summarize_results(photo_data, file_counts, quiet, debug=False):
    ...
    elif all(ext in media_exts for ext in file_counts):
